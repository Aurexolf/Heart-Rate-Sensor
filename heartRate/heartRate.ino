...
const float correlationThreshhold = 0.8;
...
boolean validHeartRate; //indicator to show if the heart rate calculation is valid
...
void loop() {
  ...
  if(checkCorrellation(irBuffer, redBuffer) > correlationThreshhold)
  calculate_heart(irBuffer, &heartRate, &validHeartRate);
